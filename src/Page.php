...
class Page {
	...
	public function __construct( $pageName, $path )
	{
		...
		$this->namespaceId = SemanticGenealogy::getNamespaceFromName( $this->namespace );
	...
	public function checkVersion() {
		...
		if ( $comment === -1 ) {
			...
			if ( $this->version == SGENEA_VERSION ) {
	...
	public function needsUpdate() {
		return ( $this->versionTag == static::PAGE_WILLUPDATE || $this->versionTag == static::PAGE_NEW ) && $this->hasChanged();
	}
